    ...
    loginPost:async function(frm,modal,url="") {
        ...
        .then((data) => {
            ...
            if(data.found){
                ...
                const userName = { token : authz[1] }//full name token
        ...
        switch (grpid){
            ...
            case "2": //if grpid 2 doctors 
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" id='drops' >
                        <a style="background-color:red;a.color:white;" class="text-white dropdown-item display-4" href="javascript:zonked.getpatientBooking(${util.user_id},'')">View Booking</a>
                    </div>
                </li>`
            break
        }
